...
RENDER.dashboard = async () => {
  ...
  $('#view').innerHTML = `
    <div class="tagline-strip">
      ...
      <button class="btn btn-green btn-sm" onclick="MATF.scope='stock';go('materials')">Browse the marketplace</button>
    </div>
...
<!-- ============================================================
     Material Reuse Group — Softr pricing embed
  ...
  @media (max-width: 600px) {
    ...
    <div class="grid cols-2">
      <div class="card">
        ...
        <p><b>Method:</b> ${esc(u.billing.method || (isFreeTier(u.tier) ? 'None — free plan' : 'Being set up — your account manager will confirm your billing details'))}</p>
      ...
      <div class="card">
        ...
        ${u.billing.invoices.length ? `<table><tr><th>Invoice</th><th>Date</th><th>Amount</th><th>Status</th></tr>
          ...
          : `<div class="empty">${isFreeTier(u.tier) ? 'No invoices — you’re on the free plan.' : 'No invoices yet.'}</div>`}
      </div>
    </div>`;
};
