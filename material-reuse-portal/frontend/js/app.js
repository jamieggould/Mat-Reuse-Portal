...
RENDER.dashboard = async () => {
  ...
  $('#view').innerHTML = `
    ...
    <h3 class="section-title">🆕 Just landed in the warehouse ${inv.earlyAccessVisible ? '<span class="pill pill-green">Priority stock access active</span>' : ''}</h3>
...
function itemCard(i) {
  return `<div class="item-card">
    ...
    <div class="item-body">
      ...
      <div class="item-carbon">🌱 ${i.carbonSavedKgPerUnit} kg CO₂e</div>
      <div class="item-foot">
    ...
    <div class="modal">
      ...
      <div style="display:flex;gap:10px;margin-top:18px;flex-wrap:wrap">
        <button class="btn btn-primary" ${canReserve ? '' : 'disabled'} onclick="reserveItem('${i.sku}')">
          ${!g.reservations ? '🔒 Reserving needs Domestic Plus Membership' : reservable ? 'Reserve this item' : 'Not currently reservable'}</button>
