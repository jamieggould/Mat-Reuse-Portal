...
function renderChat() {
  ...
  p.innerHTML = `<div class="chat-panel">
    <div class="chat-head"><div><b>MRG assistant</b><span>${CHAT.on === false ? 'Not switched on yet — email kallie@material-reuse.co.uk' : 'Knows your orders, slots, invoices and impact'}</span></div><button onclick="toggleChat(false)" aria-label="Close">✕</button></div>
    <div class="chat-log" id="chatLog">
      <div class="chat-msg bot">Hi ${esc(first)} — ask me anything about your orders, collections, memberships, passports or your impact. For anything I can't sort, I'll point you to Kallie.</div>
...
async function sendChat(text) {
  ...
  } catch (e) { CHAT.messages.push({ role: 'assistant', content: `Sorry — ${e.message}. Email kallie@material-reuse.co.uk and the team will help.` }); }
