...
function showLoginForm(ev) {
  ...
  $('#loginToggleNote').innerHTML = 'New to Material Reuse? <a href="#" onclick="toggleRegister(event)">Create a free account</a> — Domestic Free Membership, upgrade any time.';
...
async function showPublicPassport(id) {
  ...
  <div class="public-wrap"><div class="public-card">
    <div class="public-head"><div class="lockup-mini"><span>material<br>reuse</span></div><div class="kicker">${x.passportVerified ? 'Verified material passport' : 'Digital material passport'}</div></div>
