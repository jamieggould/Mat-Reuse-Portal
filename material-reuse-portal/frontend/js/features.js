...
function renderChat() {
  ...
  p.innerHTML = `<div class="chat-panel">
    <div class="chat-head"><div><b>Reuse Hub assistant</b><span>${CHAT.on === false ? 'Not switched on yet' : state.tier && state.tier.gates.passports ? 'Knows your orders, slots, invoices and impact' : 'Knows your orders, slots, credit and invoices'}</span></div><button onclick="toggleChat(false)" aria-label="Close">✕</button></div>
