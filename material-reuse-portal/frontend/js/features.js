...
function wishlistCard() {
  return `<div class="card" id="wishlistCard" style="margin-top:28px">
      ...
      <p class="small muted" style="margin-bottom:14px">Tell us what you’re after and we’ll email you the moment it comes through a strip-out${state.tier.gates.earlyAccess ? ' — priority members hear first' : ''}.</p>
...
function buyButtons(x, size = '') {
  ...
  if (x.availability === 'Pending') return `<span class="pill pill-yellow">${state.tier.gates.earlyAccess ? 'Coming soon — priority access' : 'Coming soon'}</span>`;
...
RENDER.documents = async () => {
  ...
  $('#view').innerHTML = `
    ${state.tier.gates.audits ? `<div class="tagline-strip" style="margin-bottom:12px"><span>Need a pre-refurbishment audit? It’s included in your partnership.</span>
    ...
    <div class="grid cols-2" style="margin-top:16px">
      <div class="card"><h3 style="margin-bottom:6px">Automations</h3>
        <table class="tbl small"><tr><td>Stripe balance invoices</td><td>${on(st.stripe, 'set STRIPE_SECRET_KEY on Render')}</td></tr>
          ...
          <tr><td>Wishlist alerts</td><td>${st.alertsSent} sent · ${st.alertsQueued} waiting (Free members get them 48 h after priority members)</td></tr>
