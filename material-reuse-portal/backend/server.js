...
const { DATA_DIR, load, db, PERSISTED, SUPA, SUPA_URL, supaHeaders, supaLoad, persist,
  saveUsers, saveCarbon, saveOrders, saveLists, saveProjects, saveInventory, saveSessions, saveSystem } = store;
...
const chat = require('./chat')({ db, features, integrations, automations });
