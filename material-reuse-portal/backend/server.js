...
const PERSISTED = ['users', 'inventory', 'orders', 'lists', 'carbon', 'projects', 'materials', 'documents', 'requests', 'impactEvents', 'sessions'];
...
async function api(req, res, url) {
  ...
  if (req.method === 'GET' && parts[1] === 'public' && parts[2] === 'passports' && parts[3]) {
    ...
    const pick = ['id', 'ref', 'name', 'category', 'description', 'quantity', 'unit', 'dimensions', 'condition', 'dateRecovered',
      'status', 'reuseDestination', 'dateRehomed', 'carbonSavedKg', 'carbonEstimated', 'weightKg', 'weightEstimated', 'photos', 'passportVerified'];
